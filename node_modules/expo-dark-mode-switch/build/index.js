...
export default function Switch({ onChange, style, value, ...props }) {
    const onValueChange = React.useMemo(() => () => onChange(!value), [onChange]);
    return (<TouchableOpacity accessibilityRole="button" tabIndex={0} activeOpacity={1.0} {...props} {...onEnterAndClick(onValueChange)} style={[styles.wrapper, style]}>
...
const MoonIcon = ({ isClicked, ...props }) => {
    ...
    return (<Animated.View style={[
      ...
      <SVG.Svg pointerEvents="none" {...props} style={[styles.moonSvg, props.style]} viewBox="0 0 30 32">
...
const DayNightSwitch = ({ isClicked }) => {
    ...
    return (<Animated.View ref={ref} style={[
...
const Circle = ({ isClicked, ...props }) => {
    ...
    return (<Animated.View {...props} ref={ref} style={[
        styles.circle,
        {
