    ...
    <>
      <View style={styles.container}>
        <AuthInput
          ...
          setValidation={setIsValidEmail}
          label={loc.t(Texts.email)}
        ...
        <TouchableOpacity
          ...
          <Text style={styles.textred}>{loc.t(Texts.forgotpassword)} </Text>
        </TouchableOpacity>

        <AuthButton
          label={isSignIn ? loc.t(Texts.signin) : loc.t(Texts.signup)}
          onPress={() => {
            isSignIn ? SignInUser() : RegisterUser();
          }}
        />

        <AuthButton
          label={isSignIn ? loc.t(Texts.signup) : loc.t(Texts.signin)}
          onPress={() => {
