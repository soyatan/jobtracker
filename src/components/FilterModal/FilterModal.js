...
console.log('mainfilter is', mainFilter)
 ...
 jobs?
    <View style={styles.centeredView}>
        ...
        <View style={styles.headercontainer}>
          {!isChoosing? <><TouchableOpacity><Text style={styles.header}>SELECT FILTERS</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={()=>_cleanFilter()} style={styles.button}>
            <Text style={styles.header}>CLEAR FILTERS</Text>
          </TouchableOpacity></>
          : 
          <>
          <TouchableOpacity onPress={()=>goBack()}>
           <Left width={styles.icondimensions.width} height={styles.icondimensions.height}/>           
          </TouchableOpacity>
            <TouchableOpacity onPress={()=>_cleanFilter()} style={styles.button}>
            <Text style={styles.header}>CLEAR FILTERS</Text>
          </TouchableOpacity></>
        ...
        <View style={styles.filteritemcontainer}>
          {!isChoosing?  <>
          <FilterSubText dbKey={'title'} data={createValueList('title')} isChoosing={setChoosing} activeState={setActiveFilter} state={setFilterValues} title={'JOB TİTLE'}/>
          <FilterSubText dbKey={'location'} data={createValueList('location')} isChoosing={setChoosing} activeState={setActiveFilter} state={setFilterValues} title={'LOCATION'}/>
       ...
       <View style={styles.filterfootercontainer}>
         <Text style={styles.header} onPress={()=>_onPressSubmitFilter()}>FILTER JOB APPLICATIONS</Text>
       </View>
...
/* <FilterSubText data={data} isChoosing={setChoosing} dbKey={''} state={''} title={'APPLICATION DATE'}/>
          <FilterSubText data={data} isChoosing={setChoosing} dbKey={''} state={''} title={'COMPANY NAME'}/>
          <FilterSubText data={data} isChoosing={setChoosing} dbKey={''} state={''} title={'APPLICATION STATUS'}/>*/